...
const StickyNotes=()=>{
    ...
    const [focusedNote,setFocusedNote]=useState({id:null, value:'', newNote:true,posX:null,posY:null})
    ...
    const editStickyNote=(e)=>{
        ...
        setFocusedNote({newNote:false, id:currentNote.id, value:currentNote.value, posX:currentNote.posX, posY:currentNote.posY})
    }

    return <Container>
        <AddUpdate newNote={focusedNote.newNote} noteId={focusedNote.id} noteValue={focusedNote.value} posX={focusedNote.posX} posY={focusedNote.posY} modifyStickyNotesList={modifyStickyNotesList}/>
